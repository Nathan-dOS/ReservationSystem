        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CRMNumber = table.Column<string>(type: "TEXT", maxLength: 10, nullable: true),
                    OABNumber = table.Column<string>(type: "TEXT", maxLength: 10, nullable: true),
                    Name = table.Column<string>(type: "TEXT", maxLength: 60, nullable: false),
                    PhoneNumber = table.Column<string>(type: "TEXT", maxLength: 15, nullable: false),
                    Password = table.Column<string>(type: "TEXT", maxLength: 60, nullable: false),
                    Address = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    Discriminator = table.Column<string>(type: "TEXT", maxLength: 21, nullable: false),
                    AdministrativeManager_Staff = table.Column<string>(type: "TEXT", nullable: true),
                    AssignedBuilding = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EquipmentPrice = table.Column<float>(type: "REAL", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReserveStatus = table.Column<string>(type: "TEXT", nullable: false),
                    RentPrice = table.Column<float>(type: "REAL", nullable: false),
                    ReservePhotos = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SizeInSquareMeters = table.Column<float>(type: "REAL", nullable: false),
                    ...
                    HasSecurityCamera = table.Column<bool>(type: "INTEGER", nullable: false),
